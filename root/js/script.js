...
$document.ready(function() {
    ...
    if (plugins.rdGoogleMaps.length) {
        //<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDxafVP28RV0PWwOMeVxIoHQKmeV7wra9E&callback=initMap" type="text/javascript"></script>
        $.getScript("http://maps.google.com/maps/api/js?key=AIzaSyDxafVP28RV0PWwOMeVxIoHQKmeV7wra9E&sensor=false&libraries=geometry&v=3.7", function() {
